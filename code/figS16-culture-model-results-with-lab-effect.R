# Generates figure S16, which recreates the culture model results when
...
dat.culture$lab_group <- dat.culture$article
dat.culture$lab_group[dat.culture$article %in% c("Gabitzsch et al. 2021")] <- "Battelle Biomedical Research Center"
dat.culture$lab_group[dat.culture$article %in% c("Aid et al. 2020",
                                                 "Baum et al. 2020",
...
dat.culture$lab_group[dat.culture$article %in% c("Lakshmanappa et al. 2021")] <- "California Primate Center"
dat.culture$lab_group[dat.culture$article %in% c("Deng et al. 2020A",
                                                 "Deng et al. 2020B",
                                                 "Gao et al. 2020",
                                                 "Yu (Pin) et al. 2020",
                                                 "Guo et al. 2021",
                                                 "Wang et al. 2020")] <- "CAMS (Chuan Qin)"
dat.culture$lab_group[dat.culture$article %in% c("Rockx et al. 2020")] <- "Erasmus"
dat.culture$lab_group[dat.culture$article %in% c("Yadav et al. 2021A",
                                                 "Yadav et al. 2021B")] <- "ICMR-NIV, Pune"
dat.culture$lab_group[dat.culture$article %in% c("Brouwer et al. 2021",
                                                 "Maisonasse et al. 2021",
                                                 "Maisonnasse et al. 2020",
                                                 "Sokol et al. 2021")] <- "IDMIT"
dat.culture$lab_group[dat.culture$article %in% c("Finch et al. 2020")] <- "IRF, Frederick"
dat.culture$lab_group[dat.culture$article %in% c("Nagata et al. 2021")] <- "Japan NIID"
dat.culture$lab_group[dat.culture$article %in% c("Kim et al. 2021",
                                                 "Koo et al. 2020",
                                                 "Seo et al. 2021")] <- "Korea Primate Center"
dat.culture$lab_group[dat.culture$article %in% c("Liang et al. 2021",
                                                 "Song et al. 2020",
                                                 "Song et al. 2021",
                                                 "An et al. 2021",
                                                 "Jiao et al. 2021",
...
dat.culture$lab_group[dat.culture$article %in% c("Bewley et al. 2020",
                                                 "Lambe et al. 2021",
                                                 "Rauch et al. 2020",
                                                 "Salguero et al. 2021")] <- "Public Health England"
dat.culture$lab_group[dat.culture$article %in% c("Boszormenyi et al. 2020",
                                                 "Philippens et al. 2021",
                                                 "Sanchez-Felipe et al. 2021")] <- "Rijswijk Primate Center"
dat.culture$lab_group[dat.culture$article %in% c("Furuyama et al. 2022",
                                                     "Hassan et al. 2021",
                                                     "Munster et al. 2020",
                                                     "Rosenke et al. 2020",
                                                     "Speranza et al. 2020",
...
dat.culture$lab_group[dat.culture$article %in% c("Furuyama et al. 2022",
                                                     ...
                                                     "van Doremalen et al. 2020",
                                                     "Williamson et al. 2020")] <- "RML"
dat.culture$lab_group[dat.culture$article %in% c("Gorman et al. 2021",
                                                     "Singh et al. 2020",
                                                     "Vogel et al. 2021")] <- "Southwest Primate Center"
dat.culture$lab_group[dat.culture$article %in% c("Arunachalam et al. 2021",
                                                     "Blair et al. 2021",
                                                     "Fahlberg et al. 2020",
                                                     "Huang et al. 2021")] <- "Tulane Primate Center"
dat.culture$lab_group[dat.culture$article %in% c("Cross et al. 2020",
                                                     "Cross et al. 2021",
                                                     "Woolsey et al. 2020")] <- "UTMB, Galveston"
dat.culture$lab_group[dat.culture$article %in% c("Hoang et al. 2021",
                                                     "Routhu et al. 2021")] <- "Yerkes Primate Center"

dat.culture$lab_idx <-  as.numeric(factor(dat.culture$lab_group))
...
#                                    seed = seed)
#
#fit.article$save_object(file = "./outputs/fits/fit-culture-best-with-lab-effect.RDS")
...
fit.article <- readRDS(file = "./outputs/fits/fit-culture-best-with-lab-effect.RDS")
...
# S16A: Article level differences -----------------------------------------------
...
for (article.ii in 1:10) {
  
  col_num <- which(colnames(param.article.df.wide) == paste0("psiLAB[", article.ii, "]"))
  
  for (row_num in row_nums) {
    
    for (tot.ii in c(3, 7, 11)) {
      
      y <- as.numeric(param.article.df.wide$gamma[row_num] +
        param.article.df.wide$psiT[row_num] * tot.ii +
        param.article.df.wide$'psiDPI[2]'[row_num] +
        param.article.df.wide$'psiAGE[2]'[row_num] +
        param.article.df.wide$'psiSP[1]'[row_num] +
        param.article.df.wide$psiASSAY[row_num] * 1 +
        param.article.df.wide$'psiTG[1]'[row_num] +
        param.article.df.wide$psiDOSE[row_num] * 5.5 +
        param.article.df.wide$'psiCELL[1]'[row_num] +
...
article.df$lab_group_factor <- factor(as.character(article.df$lab_group),
                                      levels = as.character(1:10))
article.df$totRNA_factor <- factor(as.character(article.df$totRNA), 
                                   levels = c("3", "7", "11"))


fig.article <- ggplot(article.df, aes(x = lab_group_factor, 
                                      y = prediction,
                                      fill = totRNA_factor)) +
...
fig3B.1 <- ggplot(subset(prediction.df, posneg == "Negative")) +
  ...
  scale_y_continuous(limits = c(0, 2.7), breaks = seq(0, 2, 1),
                     expand = c(0, 0),
                     position = "left") +
...
# S16AB: Combine into Top Panel --------------------------------------------------

fig.top <- fig.article + fig.perf + plot_layout(nrow = 1, widths = c(1, 0.7)); fig.top
...
for (x_val in x_vals) {
  y <- param.article.df.wide$gamma +
    param.article.df.wide$psiT * x_val +
    param.article.df.wide$'psiDPI[2]' +
    param.article.df.wide$'psiAGE[1]' +
    param.article.df.wide$'psiSP[1]' +
    param.article.df.wide$psiASSAY * 1 +
    param.article.df.wide$'psiTG[1]'  +
    param.article.df.wide$psiDOSE *  5.5 +
    param.article.df.wide$'psiCELL[1]'
  ...
  y <- param.article.df.wide$gamma +
    param.article.df.wide$psiT * x_val +
    param.article.df.wide$'psiDPI[2]' +
    param.article.df.wide$'psiAGE[2]' +
    param.article.df.wide$'psiSP[1]' +
    param.article.df.wide$psiASSAY * 1 +
    param.article.df.wide$'psiTG[1]'  +
    param.article.df.wide$psiDOSE *  5.5 +
  ...
  y <- param.article.df.wide$gamma +
    param.article.df.wide$psiT * x_val +
    param.article.df.wide$'psiDPI[2]' +
    param.article.df.wide$'psiAGE[3]' +
    param.article.df.wide$'psiSP[1]' +
    param.article.df.wide$psiASSAY * 1 +
    param.article.df.wide$'psiTG[1]'  +
    param.article.df.wide$psiDOSE *  5.5 +
...
for (x_val in x_vals) {
  y <- param.article.df.wide$gamma +
    ...
    param.article.df.wide$psiASSAY * 1 +
    param.article.df.wide$'psiTG[1]'  +
    param.article.df.wide$psiDOSE *  4 +
    param.article.df.wide$'psiCELL[1]'
  ...
  y <- param.article.df.wide$gamma +
    ...
    param.article.df.wide$psiASSAY * 1 +
    param.article.df.wide$'psiTG[1]'  +
    param.article.df.wide$psiDOSE *  7 +
    param.article.df.wide$'psiCELL[1]'
...
for (x_val in x_vals) {
  y <- param.article.df.wide$gamma +
    param.article.df.wide$psiT * x_val +
    param.article.df.wide$'psiDPI[1]' +
    param.article.df.wide$'psiAGE[2]' +
    param.article.df.wide$'psiSP[1]' +
    param.article.df.wide$psiASSAY * 1 +
    param.article.df.wide$'psiTG[1]'  +
  ...
  y <- param.article.df.wide$gamma +
    param.article.df.wide$psiT * x_val +
    param.article.df.wide$'psiDPI[3]' +
    param.article.df.wide$'psiAGE[2]' +
    param.article.df.wide$'psiSP[1]' +
    param.article.df.wide$psiASSAY * 1 +
    param.article.df.wide$'psiTG[1]'  +
...
for (x_val in x_vals) {
  ...
  y <- param.article.df.wide$gamma +
    ...
    param.article.df.wide$'psiTG[1]'  +
    param.article.df.wide$psiDOSE * 5.5 +
    param.article.df.wide$'psiCELL[2]'
  ...
  y <- param.article.df.wide$gamma +
    ...
    param.article.df.wide$'psiTG[1]'  +
    param.article.df.wide$psiDOSE *  5.5 +
    param.article.df.wide$'psiCELL[3]'
...
for (x_val in x_vals) {
  y <- param.article.df.wide$gamma +
    ...
    param.article.df.wide$'psiAGE[2]' +
    param.article.df.wide$'psiSP[1]' +
    param.article.df.wide$psiASSAY * 0 +
    param.article.df.wide$'psiTG[1]'  +
    param.article.df.wide$psiDOSE *  5.5 +
    param.article.df.wide$'psiCELL[1]'
...
for (ii in 1:length(dose.vary)) {
  ...
  y <- param.article.df.wide$gamma[row] +
    param.article.df.wide$psiT[row] * x_vals +
    param.article.df.wide$'psiDPI[2]'[row] +
    param.article.df.wide$'psiAGE[2]'[row] +
    param.article.df.wide$'psiSP[1]'[row] +
    param.article.df.wide$psiASSAY[row] * assay +
    param.article.df.wide$'psiTG[1]'[row]  +
    param.article.df.wide$psiDOSE[row] * dose.vary[ii] +
    param.article.df.wide$'psiCELL[1]'[row]  
...
for (ii in 1:length(dpi.vary)){
  ...
  if (dpi.vary[ii] == 1){
    dpi_sample <- param.article.df.wide$'psiDPI[1]'[row]
  }
  else if (dpi.vary[ii] == 2){
    dpi_sample <- param.article.df.wide$'psiDPI[2]'[row]
  }
  else if (dpi.vary[ii] == 3){
    dpi_sample <- param.article.df.wide$'psiDPI[3]'[row]
  }
  ...
  y <- param.article.df.wide$gamma[row] +
    ...
    param.article.df.wide$psiASSAY[row] * assay +
    param.article.df.wide$'psiTG[1]'[row]  +
    #param.article.df.wide$psiSEX[row] * sex +
    param.article.df.wide$psiDOSE[row] * dose +
    param.article.df.wide$'psiCELL[1]'[row] 
...
for (ii in 1:length(age.vary)){
  ...
  if (age.vary[ii] == 1){
    age_sample <- param.article.df.wide$'psiAGE[1]'[row]
  }
  else if (age.vary[ii] == 2){
    age_sample <- param.article.df.wide$'psiAGE[2]'[row]
  }
  else if (age.vary[ii] == 3){
    age_sample <- param.article.df.wide$'psiAGE[3]'[row]
  }
...
for (ii in 1:length(sp.vary)){
  ...
  if (sp.vary[ii] == 1){
    sp_sample <- param.article.df.wide$'psiSP[1]'[row]
  }
  else if (sp.vary[ii] == 2){
    sp_sample <- param.article.df.wide$'psiSP[2]'[row]
  }
  else if (sp.vary[ii] == 3){
    sp_sample <- param.article.df.wide$'psiSP[3]'[row]
  }
...
for (ii in 1:length(assay.vary)){
  ...
  y <- param.article.df.wide$gamma[row] +
    ...
    param.article.df.wide$'psiAGE[2]'[row] +
    param.article.df.wide$'psiSP[1]'[row] +
    param.article.df.wide$psiASSAY[row] * assay.vary[ii] +
    param.article.df.wide$'psiTG[1]'[row]  +
    #param.article.df.wide$psiSEX[row] * sex +
    param.article.df.wide$psiDOSE[row] * dose +
    param.article.df.wide$'psiCELL[1]'[row]  
...
for (ii in 1:length(tg.vary)){
  ...
  if (tg.vary[ii] == 1){
    tg_sample <- param.article.df.wide$'psiTG[1]'[row]
  }
  else if (tg.vary[ii] == 2){
    tg_sample <- param.article.df.wide$'psiTG[2]'[row]
  }
  else if (tg.vary[ii] == 3){
    tg_sample <- param.article.df.wide$'psiTG[3]'[row]
  }
...
for (ii in 1:length(cell.vary)){
  ...
  if (cell.vary[ii] == 1){
    cell_sample <- param.article.df.wide$'psiCELL[1]'[row]
  }
  else if (cell.vary[ii] == 2){
    cell_sample <- param.article.df.wide$'psiCELL[2]'[row]
  }
  else if (cell.vary[ii] == 3){
    cell_sample <- param.article.df.wide$'psiCELL[3]'[row]
  }
...
fig.cell.fits <- ggplot(data = lines.cell.df) + 
  ...
  geom_line(data = as.data.frame(lines.simple.df),
            ...
            color = "#002C3D",
            size = 1) +
  scale_color_manual(values = c("76" = "#bc4749",   #"#5C3E49",
                                "E6" = "#386641",  #"#863855",
                                "E6-SS2" = "#a7c957")) +  #"#D980A0")) +
...
ggsave('./outputs/figures/figS16-culture-model-results-with-lab-effect.tiff',
       plot = fig4,
       device = 'tiff',
       height = 10.5,
       width = 9,
